...
class STT_Node(Node):
    ...
    def create_speaker_recognition(self):
        ...
        speaker_file = '/home/xilanhua/Voice_Assistant/speaker_audio/speakers.txt'
        config = sherpa_onnx.SpeakerEmbeddingExtractorConfig(
            model='/home/xilanhua/Voice_Assistant/model/speaker_recogition/3dspeaker_speech_eres2net_base_200k_sv_zh-cn_16k-common.onnx',
            num_threads=1,
            debug=False,
            provider='cpu'
        )
    ...
    def create_recognizer(self):
        ...
        recognizer = sherpa_onnx.OnlineRecognizer.from_transducer(
            tokens='/home/xilanhua/Voice_Assistant/model/sherpa-onnx-streaming-zipformer-bilingual-zh-en-2023-02-20/tokens.txt',
            encoder='/home/xilanhua/Voice_Assistant/model/sherpa-onnx-streaming-zipformer-bilingual-zh-en-2023-02-20/encoder-epoch-99-avg-1.onnx',
            decoder='/home/xilanhua/Voice_Assistant/model/sherpa-onnx-streaming-zipformer-bilingual-zh-en-2023-02-20/decoder-epoch-99-avg-1.onnx',
            joiner='/home/xilanhua/Voice_Assistant/model/sherpa-onnx-streaming-zipformer-bilingual-zh-en-2023-02-20/joiner-epoch-99-avg-1.onnx',
            num_threads=1,
            sample_rate=16000,
            feature_dim=80,
